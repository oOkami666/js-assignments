[![Build Status](https://travis-ci.org/oOkami666/js-assignments.svg?branch=master)](https://travis-ci.org/oOkami666/js-assignments)
![Hackage-Deps](https://img.shields.io/hackage-deps/v/lens.svg)
[![Greenkeeper badge](https://badges.greenkeeper.io/oOkami666/js-assignments.svg)](https://greenkeeper.io/)
[![GitHub release](https://img.shields.io/github/release/oOkami666/js-assignments.svg)](https://github.com/oOkami666/js-assignments/releases/latest)
...
* Edit local README.md file and update all links (just replace all occurrences of `'oOkami666'` with your account name).
...
```
* Open https://github.com/oOkami666/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/oOkami666/js-assignments/builds).
